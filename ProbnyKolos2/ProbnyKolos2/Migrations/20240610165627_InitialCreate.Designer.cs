...
namespace ProbnyKolos2.Migrations
{
    ...
    [Migration("20240610165627_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProbnyKolos2.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProbnyKolos2.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProbnyKolos2.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProbnyKolos2.Models.OrderPastry", b =>
                {
            ...
            modelBuilder.Entity("ProbnyKolos2.Models.Pastry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProbnyKolos2.Models.Order", b =>
                {
                    b.HasOne("ProbnyKolos2.Models.Client", "Client")
                        .WithMany("Orders")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProbnyKolos2.Models.Employee", "Employee")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ProbnyKolos2.Models.OrderPastry", b =>
                {
                    b.HasOne("ProbnyKolos2.Models.Order", "Order")
                        .WithMany("OrderPastries")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProbnyKolos2.Models.Pastry", "Pastry")
                        .WithMany("OrderPastries")
